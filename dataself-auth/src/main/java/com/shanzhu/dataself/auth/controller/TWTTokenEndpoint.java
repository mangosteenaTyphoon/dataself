...
import com.shanzhu.dataself.api.system.feign.RemoteOauth2ClientDetailsService;
import com.shanzhu.dataself.framework.core.application.domain.AjaxResult;
...
import com.shanzhu.dataself.framework.security.exception.OAuthClientException;
import com.shanzhu.dataself.framework.security.utils.OAuth2EndpointUtils;
import com.shanzhu.dataself.framework.security.utils.OAuth2ErrorCodesExpand;
...
public class TWTTokenEndpoint {
	...
	/**
	 * 认证页面（localhost:8888/oauth/authorize?response_type=code&client_id=shanzhu&scope=server&redirect_uri=https://shanzhu.cloud）
	 * @param modelAndView
