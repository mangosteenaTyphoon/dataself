package com.shanzhu.dataself.auth.support.core;

import com.shanzhu.dataself.auth.support.handler.FormAuthenticationFailureHandler;
import com.shanzhu.dataself.auth.support.handler.SsoLogoutSuccessHandler;
