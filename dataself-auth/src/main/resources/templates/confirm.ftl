...
<nav class="navbar navbar-default container-fluid">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">shanzhu - 开放平台</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://shanzhu.cloud">欢迎您，${principalName}</a>
            </p>
        </div>
    </div>
</nav>
<div style="padding-top: 80px;width: 300px; color: #555; margin:0 auto;">
    ...
    <footer style="clear:both;text-align: center">
        <a href="https://shanzhu.cloud" target="_blank">Powered By shanzhu</a>
    </footer>
</div>
