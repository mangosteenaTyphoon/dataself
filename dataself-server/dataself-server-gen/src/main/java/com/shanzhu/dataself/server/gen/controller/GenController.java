...
import com.shanzhu.dataself.framework.utils.Convert;
import com.shanzhu.dataself.server.gen.service.IGenTableColumnService;
...
public class GenController extends TWTController {
	...
	private void genCode(HttpServletResponse response, byte[] data) throws IOException {
		...
		response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"shanzhu.zip\"");
