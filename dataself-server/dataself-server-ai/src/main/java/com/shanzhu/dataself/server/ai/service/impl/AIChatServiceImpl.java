...
import com.shanzhu.dataself.ai.constant.ModelEnums;
import com.shanzhu.dataself.ai.constant.RAGEnums;
import com.shanzhu.dataself.ai.domain.AiChatHistory;
import com.shanzhu.dataself.ai.domain.AiKnowledge;
import com.shanzhu.dataself.ai.domain.AiModel;
import com.shanzhu.dataself.ai.domain.dto.*;
import com.shanzhu.dataself.ai.domain.ocr.InvoiceOCR;
import com.shanzhu.dataself.ai.domain.vo.AiChatHistoryPageVO;
import com.shanzhu.dataself.ai.domain.vo.AiChatHistoryVO;
import com.shanzhu.dataself.ai.domain.vo.MessageVO;
...
import com.shanzhu.dataself.framework.utils.TUtils;
import com.shanzhu.dataself.server.ai.client.AIClient;
import com.shanzhu.dataself.server.ai.constant.AIDataSourceConstants;
import com.shanzhu.dataself.server.ai.constant.RAGConstants;
import com.shanzhu.dataself.server.ai.mapper.*;
import com.shanzhu.dataself.server.ai.model.MCPService;
...
import com.shanzhu.dataself.server.ai.utils.ModelUtils;
import com.shanzhu.dataself.server.ai.utils.VectorStoreUtils;
...
public class AIChatServiceImpl implements AIChatService {
	 ...
	 * 多模态测试图片地址
	 */
	private final static String MULTI_IMAGE_FILE_URL = "https://static.shanzhu.cloud/ai/dog_and_girl.jpeg";

	/**
	 * OCR识别
	 */
	private final static String OCR_IMAGE_FILE_URL = "https://static.shanzhu.cloud/ai/ocr.jpg";

	/**
	 * 多模态测试视频地址
	 */
	private final static String MULTI_VIDEO_FILE_URL = "https://static.shanzhu.cloud/ai/video.mp4";
	...
	public Flux<MessageVO> multiChatStream(MessageDTO messageDTO) {
		File file = null;
		String TEMP_IMAGE_DIR = "shanzhu_ai_temp";
