package com.shanzhu.dataself.server.ai.fun.rag;

import com.shanzhu.dataself.server.ai.fun.vo.ResponseVO;
...
public class RAGServiceTools {
	...
	public ResponseVO getOrder(RAGRequest ragRequest) {
		return new ResponseVO(String.format("shanzhu是一个开源的Java开发脚手架"));
	}
