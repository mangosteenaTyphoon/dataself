...
import com.shanzhu.dataself.framework.datascope.annotation.SysDataScope;
...
public class SysDataScopeAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(annotation.datascope.framework.com.shanzhu.dataself.SysDataScope)")
