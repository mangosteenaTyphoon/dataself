package com.shanzhu.dataself.framework.job.config;

import com.shanzhu.dataself.framework.job.config.properties.XxlExecutorProperties;
import com.shanzhu.dataself.framework.job.config.properties.XxlJobProperties;
