package com.shanzhu.dataself.framework.log.aspect;
...
import com.shanzhu.dataself.framework.log.enums.BusinessStatus;
...
import com.shanzhu.dataself.framework.utils.http.IpUtils;
...
public class SysLogAspect {
	 ...
	 * 配置切入点
	 */
	@Pointcut("@annotation(annotation.log.framework.com.shanzhu.dataself.Log)")
