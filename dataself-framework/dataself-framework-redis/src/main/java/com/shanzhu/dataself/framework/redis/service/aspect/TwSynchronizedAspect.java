package com.shanzhu.dataself.framework.redis.service.aspect;

import com.shanzhu.dataself.framework.redis.service.annotation.TwSynchronized;
...
public class TwSynchronizedAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(annotation.service.redis.framework.com.shanzhu.dataself.TwSynchronized)")
